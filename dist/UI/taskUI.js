// =======================================================================
import { addTaskBtn, completedTasksContainer, notCompletedTasksContainer, taskCategoryOptions, taskTitleInput, } from "../index.js";
import { completedTasksArr, deleteTasks, disabledTask, handleAddTaskClicked, handleCompletedTasks, notCompletedTasksarr, toggleDisabledTasks, updateTask, } from "../services/taskServices.js";
export let taskCategory = "BUSINESS";
// Render notCompleted Tasks Container
export const renderNotCompletedTasks = () => {
    // Clear All Element
