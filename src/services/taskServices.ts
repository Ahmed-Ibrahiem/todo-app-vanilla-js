...
export let completedTasksArr: completedTasksType[] = JSON.parse(
  localStorage.getItem("completedTasks") || "[]",
) as completedTasksType[];

export let notCompletedTasksarr: notCompletedTasksType[] = JSON.parse(
  localStorage.getItem("notCompletedTasks") || "[]",
) as notCompletedTasksType[];

export let disabledTasksArr: string[] = JSON.parse(
  localStorage.getItem("disabledTasks") || "[]",
);

// =======================================================================
// [2] When user click on "add_task" btn.
export const handleAddTaskClicked = (e: PointerEvent): void => {
...
export const handleCompletedTasks = (id: string): void => {
...
export const updateTask = (taskElement: HTMLElement): void => {
...
export const deleteTasks = (taskElement: HTMLLIElement): void => {
...
export const toggleDisabledTasks = (id: string) => {
...
export const disabledTask = (): void => {
